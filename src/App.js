...
// Utility function to check if a 3x3 board has a winner
...
export default function App() {
  ...
  let status = overallWinner
    ...
    : `Next player: ${xIsNext ? "X" : "O"}${forcedBoard !== null ? ` — Play in board #${forcedBoard + 1}` : ""}`;
